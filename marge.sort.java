...
public class marge_sort {
    ...
    public marge_sort(ArrayList<Integer> arrayToSort) {
    ...
    public static void main(String[] args) {
        ...
        marge_sort marge_sort = new marge_sort(integerArrayList);

        System.out.print("Array Sebelum Merge Sort : ");
        for (Integer integer : marge_sort.getArrayAfterSorting()) {
            System.out.print(integer+" ");
        }

        System.out.println();

        marge_sort.divideArrayElements(0, integerArrayList.size() - 1);

        System.out.print("Array Setelah Marge Sort : ");
        for (Integer integer : marge_sort.getArrayAfterSorting()) {
            System.out.print(integer+" ");
}
         System.out.println();
